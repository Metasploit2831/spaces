...
export function CanvasToolbar({ canGroup, hasSelection, onAddText, onGroup, onUngroup, onDelete }: CanvasToolbarProps) {
  return (
    <div className="flex items-center gap-1.5 border-y border-zinc-800 bg-zinc-950 px-3 py-2">
      ...
      <div className="ml-auto rounded-md border border-zinc-800 bg-zinc-900 px-2.5 py-1 text-[11px] font-semibold text-zinc-400">
        Paste Cmd + V
      </div>
